...
namespace OutlookAddIn1 {
    ...
    public sealed partial class AutoLottieAddIn : Microsoft.Office.Tools.Outlook.OutlookAddInBase {
        ...
        public AutoLottieAddIn(global::Microsoft.Office.Tools.Outlook.Factory factory, global::System.IServiceProvider serviceProvider) : 
    ...
    internal sealed partial class Globals {
        ...
        private static AutoLottieAddIn _AutoLottieAddIn;
        ...
        internal static AutoLottieAddIn AutoLottieAddIn {
            get {
                return _AutoLottieAddIn;
            }
            set {
                if ((_AutoLottieAddIn == null)) {
                    _AutoLottieAddIn = value;
                }
                else {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.AutoLottieAddIn.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionCollectionBase {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return ((WindowFormRegionCollection)(Globals.AutoLottieAddIn.GetFormRegions(explorer, typeof(WindowFormRegionCollection))));
            }
        }
        
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Inspector inspector] {
            get {
                return ((WindowFormRegionCollection)(Globals.AutoLottieAddIn.GetFormRegions(inspector, typeof(WindowFormRegionCollection))));
            }
        }
    }
